# Generated by Django 3.2 on 2022-09-07 17:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updateTime', models.DateTimeField(auto_now_add=True, verbose_name='update time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdTime', models.DateTimeField(auto_now_add=True, verbose_name='created time')),
                ('updateTime', models.DateTimeField(auto_now_add=True, verbose_name='update time')),
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='products.product', verbose_name='products')),
            ],
            options={
                'verbose_name': 'file',
